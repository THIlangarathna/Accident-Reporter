...
{
?>
<div style="width: 40%;float:left;height:auto;text-align: left;background-color: #808080;padding-left: 50px;padding-top: 50px;padding-right: 50px;margin-right: 5%;margin-left: 5%;">
...
?>
        <!--Confirm Box-->
        <center>
    <form action="AccidentConfirm.php" method="post" enctype="multipart/form-data"><br>
        <input type="text" hidden="" name="email">
        <input type="text" value="<?php echo "$id" ?>" hidden name="id">
      <b>Accident Status</b><br>
      <select style="width: 200px;height: 30px;" name="status" type="text">
          <option value="Normal" type="text" style="background-color: yellow;">Normal</option>
          <option value="Serious" type="text" style="background-color: orange;">Serious</option>
          <option value="Critical" type="text" style="background-color: red;">Critical</option>
        </select>
        <br>
